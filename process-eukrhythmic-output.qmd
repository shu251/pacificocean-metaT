...
## Use DESeq to export TPM values & transformed data
...
_rlog_ is regularized log. It transforms the original count data into the log2 scale and fits a model with a term for each sample. 
